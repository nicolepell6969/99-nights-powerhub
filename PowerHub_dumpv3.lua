-- ============================================
--  PowerHub - DATA DUMPER v3  (99 Nights)
--  Full dump, automatic upload via POST to VPS
--  endpoint -> saved -> auto-pushed to GitHub.
--  Builds the entire dump string, then POSTs
--  it (no console truncation, no copy-paste).
--
--  Uses a background thread so huge dumps don't
--  block. After POST, prints the GitHub URL.
-- ============================================
...
log("===== POWERHUB DATA DUMPER v3 mulai =====")
